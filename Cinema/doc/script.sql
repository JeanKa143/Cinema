...
CREATE TABLE IF NOT EXISTS `bd_cinema`.`tiquete` (
  ...
  INDEX `fk_tiquete_asiento_funcion_idx` (`asiento_funcion_sala_cinema_id` ASC, `asiento_funcion_sala_numero` ASC, `asiento_funcion_fecha` ASC, `asiento_funcion_fila` ASC, `asiento_funcion_posicion` ASC) VISIBLE,
